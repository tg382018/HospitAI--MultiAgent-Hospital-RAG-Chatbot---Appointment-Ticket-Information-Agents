...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_tickets_reporter_user_id"), "tickets", ["reporter_user_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_appointments_patient_user_id"), "appointments", ["patient_user_id"], unique=False
    )
    op.create_index(op.f("ix_appointments_status"), "appointments", ["status"], unique=False)
    op.create_index(
        "ix_appointments_tenant_doctor_starts",
        "appointments",
        ["tenant_id", "doctor_id", "starts_at"],
        unique=False,
    )
    op.create_index(op.f("ix_appointments_tenant_id"), "appointments", ["tenant_id"], unique=False)
    op.create_index(
        "ix_appointments_tenant_starts", "appointments", ["tenant_id", "starts_at"], unique=False
    )
    op.create_table(
